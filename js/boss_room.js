...
gameEngine.boss_room ={
    ...
    create:function(){
        ...
        this.map = this.game.add.tilemap('boss_room');
        ...
        this.mapCollisions = this.map.createLayer('collidables');
        this.map.setCollisionBetween(1,178,true,'collidables');
